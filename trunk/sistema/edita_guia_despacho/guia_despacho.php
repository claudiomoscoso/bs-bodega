...
$numero = $_POST["txtDespacho"];
$stmt = mssql_query("EXEC Bodega..sp_getGuiaDespacho 1, $numero, '$bodega'", $cnx);
...
function Blur(ctrl){
	...
	if(ctrl.value != document.getElementById('hdnDespacho').value)
		document.getElementById('transaccion').src = 'transaccion.php?modulo=2&despacho=' + ctrl.value;
}
...
function Load(){
	...
	if(document.getElementById('detalle')){
		...
		document.getElementById('detalle').src = 'detalle_guia_despacho.php?usuario=<?php echo $usuario;?>&numero=<?php echo $numero;?>';
	}
}
...
if($existe == 1){?>
	<tr>
		<td align="center">
			<table border="0" width="100%" cellpadding="1" cellspacing="0">
				<tr>
					<td width="7%" align="left" >&nbsp;N&deg;Despacho</td>
					<td width="1%" align="center">:</td>
					<td>
						<table border="0" width="100%" cellpadding="0" cellspacing="0">
							<tr>
								<td width="10%">
									<input name="txtDespacho" id="txtDespacho" class="txt-plano" style="width:99%; text-align:center" value="<?php echo $numero;?>" 
	...
	<tr>
		<td align="right">
			...
			<input type="hidden" name="hdnDespacho" id="hdnDespacho" value="<?php echo $numero;?>" />
