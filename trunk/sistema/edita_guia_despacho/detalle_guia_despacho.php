...
$numero = $_GET["numero"];
mssql_query("EXEC Bodega..sp_getTMPDetalleGuiaDespacho 1, NULL, '$usuario', $numero", $cnx);
?>
...
<?php
$stmt = mssql_query("EXEC Bodega..sp_getTMPDetalleGuiaDespacho 2, NULL, '$usuario'", $cnx);
