...
<body topmargin="0px" style="background-color:#FFFFFF">
<?php
$stmt = mssql_query("EXEC Orden..sp_getBitacora 1, '$contrato', '$movil'", $cnx);
		...
		<td>
			<table border="0" width="100%" cellpadding="1" cellspacing="0">
				...
				<tr>
					...
					<td valign="top">:</td>
					<td valign="top">&nbsp;<?php echo $rst["strDireccion"];?></td>
					<td >&nbsp;</td>
					<td valign="top"><b>&nbsp;Term.Hidraul.</b></td>
					<td valign="top">:</td>
					<td valign="top">&nbsp;<?php echo formato_fecha($rst["dtmOrden"], true, false);?></td>
				</tr>
				<tr>
					...
					<td >&nbsp;</td>
					<td valign="top"><b>&nbsp;Fch. Anexo</b></td>
					<td valign="top">:</td>
					<td valign="top">&nbsp;<?php echo formato_fecha($rst["dtmAnexo"], true, false);?></td>
				</tr>
				<tr>
					<td ><b>&nbsp;Comuna</b></td>
					<td >:</td>
					...
					<td >&nbsp;</td>
					<td ><b>&nbsp;Venc. Anexo</b></td>
					<td >:</td>
						<td >&nbsp;<?php echo ($rst["dtmVAnexo"] != '' ? formato_fecha($rst["dtmVAnexo"], true, false) : '');?></td>
				</tr>
