...
if($accion == 'A')
	mssql_query("EXEC sp_setTMPDetalleOrdenCompra 7, '$usuario', '$bodega', NULL, '$codigo', NULL, NULL, NULL, $cantidad, $valor", $cnx);
elseif($accion=='E')
	mssql_query("EXEC sp_setTMPDetalleOrdenCompra 8, '$usuario', '$bodega', NULL, '$codigo'", $cnx);
?>
...
<?php
$stmt = mssql_query("EXEC sp_getTMPDetalleOrdenCompra 2, '$usuario', '$bodega'", $cnx);
