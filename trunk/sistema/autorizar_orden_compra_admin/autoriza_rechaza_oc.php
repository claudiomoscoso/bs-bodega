...
$stmt = mssql_query("EXEC General..sp_getCargos 14,'', '$strcargo'", $cnx);
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<?php 
						...
						$stmt = mssql_query("SELECT DISTINCT strAutoriza FROM Autorizaciones WHERE dblNumero=$numero AND strAccion='1'", $cnx);
						if($rst=mssql_fetch_array($stmt)) echo '<br>&nbsp;<b>V&deg;B&deg;:</b> '.$rst["strAutoriza"];
						mssql_free_result($stmt);
					?>
					</td>
				</tr>
