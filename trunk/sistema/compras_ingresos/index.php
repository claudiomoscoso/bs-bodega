...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td width="25%">
						...
						<?php
						$stmt = mssql_query("EXEC General..sp_getContratos 2, $usuario", $cnx);
		...
		<td>
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					...
					<th width="10%" align="left">O.Compra</th>
					<th width="10%">Monto O.C.</th>
					<th width="10%">Monto Ing</th>
					<th width="8%">NºIngreso</th>
					<th width="8%">Fecha</th>
					<th width="8%">Monto</th>
					<th width="8%">Guia</th>
	...
	<tr>
		<td align="right">
			...
			/></td>
					<td width="10%" align="right" id=TotalC>0</td>

					<td width="10%" align="right" id=TotalI>0</td>
					<td width="20%" align="right" id=TotalI>&nbsp;</td>
					<td width="20%" align="right" id=TotalI>&nbsp;</td>
					<td width="2%">&nbsp;</td>
				</tr>
			</table>
