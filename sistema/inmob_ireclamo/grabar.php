...
$stmt = mssql_query("EXEC Orden..sp_setOrdenTrabajo 1, '$usuario', '$contrato', '$movil', '$orden', '$fecha', '$vence', '$ttrabajo', '$prioridad', '$motivo', '$cliente', '$direccion', '$entrecalle', '$comuna', '$zona', '$faxods', '$inspector', '$observacion'", $cnx);
