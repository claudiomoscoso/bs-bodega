...
function Load(){
	document.getElementById('frmResultado').setAttribute('height', window.innerHeight - 90);
}
...
function Buscar(){
	...
	document.getElementById('frmResultado').src = 'resultado.php?bodega=' + bodega + '&material=' + material;
}
...
function Exporta(){
	if(frmResultado.document.getElementById('totfil')){
		var bodega = document.getElementById('cmbBodega').value;
		var material = document.getElementById('hdnMaterial').value;
		document.getElementById('frmResultado').src = 'exporta.php?bodega=' + bodega + '&material=' + material;
	}else{
		alert('No se ha realizado ninguna busqueda.');
	}
}
-->
</script>
<body onload="javascript: Load();">
<div id="divBuscador" style="position:absolute; top:5px; left:15%; width:70%; visibility:hidden">
