		...
		$cont = 1;?>
			...
			<table border="1" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td width="9%" align="center"><b>Fecha</b></td>
	...
	<?php
			...
			<table border="1" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td width="9%" align="left" style="font-size:10px"><input class="txt-sborde" style="width:99%" value="&nbsp;<?php echo formato_fecha($rst["dtmOrden"]);?>" /></td>
					...
					<td width="9%" align="right" style="font-size:10px"><?php echo number_format($rst["dblTotal"], 0, '', '.');?>&nbsp;</td>Envio
				</tr>
			</table>
<?php
