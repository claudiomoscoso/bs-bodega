...
<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0">
	<tr><th align="right"><a href="../proveedor/index.php?modulo=orden_compra_arriendo&foco=<?php echo $foco;?>&ctrl=<?php echo $ctrl;?>&consulta=<?php echo $texto;?>">Agregar Proveedor</a>&nbsp;</th></tr>
	<tr>
		<td>
