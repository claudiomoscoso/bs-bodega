...
function Load(){
	document.getElementById('frmAdquisiciones').setAttribute('height', (window.innerHeight / 1) - 25);
	...
	<tr>
		<td valign="top">
			<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="2">
				...
				<tr><td><iframe name="frmOCompra" id="frmOCompra" frameborder="0" scrolling="no" width="100%" height="250px" marginwidth="0" marginheight="0" src="../cargando.php"></iframe></td></tr>
				<tr>
					<td>
						<table border="0" width="100%" cellpadding="0" cellspacing="0">
							<tr>
