...
function Buscar(){
	if(document.getElementById('txtDevolucion').value == '')
		...
		document.getElementById('frm').setAttribute('action', 'guia_devolucion.php?usuario=<?php echo $usuario;?>');
		...
		<td>
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td width="1%">&nbsp;</td>
					<td width="7%">&nbsp;N&deg;Devoluci&oacute;n</td>
					<td width="1%" align="center">:</td>
					<td width="10%">
						<input name="txtDevolucion" id="txtDevolucion" class="txt-plano" style="width:99%; text-align:center" 
