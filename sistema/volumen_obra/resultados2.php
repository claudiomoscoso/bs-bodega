...
<?php
$sql="EXEC Orden..sp_getDetalleInformeOrden 3, '$contrato', NULL, $finicio, $ftermino, '$estado', '$usuario'";
...
if($rst = mssql_fetch_array($stmt)){
	...
	do{
		...
		echo '<td width="3%" align="center">'.trim($rst["strItem"]).'</td>';
		...
		echo '/>';
		echo '</td>';
		echo '<td width="3%" align="center">'.trim($rst["strUnidad"]).'</td>';
		echo '<td width="5%" align="right">'.number_format($rst["INFO"], 2, ',', '.').'&nbsp;</td>';
		echo '<td width="5%" align="right">'.number_format($rst["INFOZ1"], 2, ',', '.').'&nbsp;</td>';
		echo '<td width="5%" align="right">'.number_format($rst["INFOZ2"], 2, ',', '.').'&nbsp;</td>';
		echo '<td width="5%" align="right">'.number_format($rst["INFOZ3"], 2, ',', '.').'&nbsp;</td>';
		echo '<td width="5%" align="right">'.number_format($rst["COBRO"], 2, ',', '.').'&nbsp;</td>';
		echo '<td width="5%" align="right">'.number_format($rst["COBROZ1"], 2, ',', '.').'&nbsp;</td>';
		echo '<td width="5%" align="right">'.number_format($rst["COBROZ2"], 2, ',', '.').'&nbsp;</td>';
		echo '<td width="5%" align="right">'.number_format($rst["COBROZ3"], 2, ',', '.').'&nbsp;</td>';
		echo '<td width="5%" align="right">'.number_format($rst["TINFO"], 0, '', '.').'&nbsp;</td>';
		echo '<td width="5%" align="right">'.number_format($rst["TINFOZ1"], 0, '', '.').'&nbsp;</td>';
		echo '<td width="5%" align="right">'.number_format($rst["TINFOZ2"], 0, '', '.').'&nbsp;</td>';
		echo '<td width="5%" align="right">'.number_format($rst["TINFOZ3"], 0, '', '.').'&nbsp;</td>';
		echo '<td width="5%" align="right">'.number_format($rst["TCOBRO"], 0, '', '.').'&nbsp;</td>';
		echo '<td width="5%" align="right">'.number_format($rst["TCOBROZ1"], 0, '', '.').'&nbsp;</td>';
		echo '<td width="5%" align="right">'.number_format($rst["TCOBROZ2"], 0, '', '.').'&nbsp;</td>';
		echo '<td width="5%" align="right">'.number_format($rst["TCOBROZ3"], 0, '', '.').'&nbsp;</td>';
		echo '</tr>';
		$TotalInforme+=$rst["TINFO"];
		$TotalPagado+=$rst["TCOBRO"];
