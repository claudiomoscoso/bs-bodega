...
<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0" class="ventana2">
	<tr><td align="right"><a href="../proveedor/index.php?modulo=orden_compra_manual&consulta=<?php echo $texto;?>">Agregar Proveedor</a>&nbsp;</td></tr>
	<tr>
		<td>
			...
			if($rst = mssql_fetch_array($stmt)){
				do{
					...
					echo '<option value="'.$rst["strCodigo"].'">['.trim($rst["strRut"]).'] '.trim($rst["strNombre"]).'</option>';
